      ...
      <div className='flex flex-col items-center justify-center h-full'>
        <div className='flex items-center gap-20'>
          <div className='text-5xl flex flex-col space-y-3'>
            ...
            <button className='border-2 border-black rounded-full px-4 py-2 text-lg brand-shadow hover:bg-main hover:text-white transition-all'>dive in and get to know me ?</button>
          </div>
          <div>
            <Image
              unoptimized
